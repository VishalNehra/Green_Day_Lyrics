...
public class Whencomearound extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ins_whencomearound);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				if(item.getItemId()==R.id.reportsong)
				{
				    ...
				    log.info("International Superhits/When I Come Around");
				    Report.report1(this);
					}
					else
					{
				...
				if(item.getItemId()==R.id.action_label)
				{
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Whencomearound.this, com.greenday.dookie.Whencomearound.class);
			                startActivity(intent);
			            }
			        })
			        .show();    
