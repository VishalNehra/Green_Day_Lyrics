...
public class Basketcase extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ins_basketcase);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				if(item.getItemId()==R.id.reportsong)
				{
				    ...
				    log.info("International Superhits/Basket Case");
				    Report.report1(this);
					}
					else
					{
				...
				if(item.getItemId()==R.id.action_label)
				{
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Basketcase.this, com.greenday.dookie.Basketcase.class);
			                startActivity(intent);
			            }
			        })
			        .show();  
