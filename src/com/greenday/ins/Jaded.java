...
public class Jaded extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ins_jaded);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Jaded.class);
				    log.info("International Superhits/Jaded");
				    Report.report1(this);
				}
				...
				if(item.getItemId()==R.id.action_label)
				{
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Jaded.this, com.greenday.insomniac.Jaded.class);
			                startActivity(intent);
			            }
			        })
			        .show(); 
