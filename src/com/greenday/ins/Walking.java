...
public class Walking extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ins_walking);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Walking.class);
				    log.info("International Superhits/Walking Contradiction");
				...
				if(item.getItemId()==R.id.action_label)
				{
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Walking.this, com.greenday.insomniac.Walking.class);
			                startActivity(intent);
			            }
			        })
			        .show(); 
