...
public class Stuckwithme extends Activity {
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Stuckwithme.class);
				    log.info("International Superhits/Stuck With Me");
				...
				if(item.getItemId()==R.id.action_label)
				{
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Stuckwithme.this, com.greenday.insomniac.Stuckwithme.class);
			                startActivity(intent);
			            }
			        })
			        .show();    
