...
public class Longview extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ins_longview);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Longview.class);
				    log.info("International Superhits/Longview");
				...
				{
					//Info
					AlertDialog builder = new AlertDialog.Builder(Longview.this)
			        ...
			        .setNegativeButton("Go To Original", new DialogInterface.OnClickListener() {
			            public void onClick(DialogInterface dialog, int which) {
			                Intent intent=new Intent(Longview.this, com.greenday.dookie.Longview.class);
			                startActivity(intent);
			            }
			        })
			        .show();  
