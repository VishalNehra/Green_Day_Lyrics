...
public class Tcb extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tcb_tcb);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
			//Log report
		    Logger log = LoggerFactory.getLogger(Tcb.class);
		    log.info("21st Centuary Breakdown/21st Centuary Breakdown");
		...
		{
			//Info
			AlertDialog builder = new AlertDialog.Builder(Tcb.this)
