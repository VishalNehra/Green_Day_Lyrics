...
public class Worryrock extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nimrod_worryrock);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
			//Log report
		    Logger log = LoggerFactory.getLogger(Worryrock.class);
		    log.info("Nimrod/Worry Rock");
		...
		{
			//Info
			AlertDialog builder = new AlertDialog.Builder(Worryrock.this)
