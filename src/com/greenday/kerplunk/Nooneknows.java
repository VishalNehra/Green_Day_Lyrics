...
public class Nooneknows extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kerplunk_nooneknows);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Nooneknows.class);
				    log.info("Kerplunk/No One Knows");
				    Report.report1(this);
				}
