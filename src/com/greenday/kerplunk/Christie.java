...
public class Christie extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kerplunk_christie);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Christie.class);
				    log.info("Kerplunk/Christie Road");
				...
				{
					//Info
					AlertDialog builder = new AlertDialog.Builder(Christie.this)
