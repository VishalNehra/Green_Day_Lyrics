	...
	public static class Board extends FrameLayout
    {
        ...
        public class Bean extends ImageView {
            ...
            private void pickBean() {
                ...
                setLayerType(View.LAYER_TYPE_HARDWARE, (beanId == R.drawable.picks) ? null : pt);
            }
...
//            android.util.Log.d("Nyandroid", "resized: " + w + "x" + h);
    ...
    public void onStart() {
        ...
        pm.setComponentEnabledSetting(new ComponentName(this, Beanbag.class),
