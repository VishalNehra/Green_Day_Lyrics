...
public class Holiday extends Activity implements OnRefreshListener{
						...
						new CountDownTimer(232000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Holiday.this, "Finished", Style.CONFIRM).show();
