...
public class Shesarebel extends Activity implements OnRefreshListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.americanidiot_shesarebel);
						...
						new CountDownTimer(180000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Shesarebel.this, "Finished", Style.CONFIRM).show();
