...
public class Letterbomb extends Activity implements OnRefreshListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.americanidiot_letterbomb);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Letterbomb.class);
			    log.info("American Idiot/Letterbomb");
						...
						new CountDownTimer(245000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Letterbomb.this, "Finished", Style.CONFIRM).show();
