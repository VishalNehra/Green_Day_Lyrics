...
public class Givemenov extends Activity implements OnRefreshListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.americanidiot_givemenov);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Givemenov.class);
			    log.info("American Idiot/Give Me Novacaine");
						...
						new CountDownTimer(205000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Givemenov.this, "Finished", Style.CONFIRM).show();
