...
public class Wakemeup extends Activity {
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Wakemeup.class);
			    log.info("American Idiot/Wake Me Up When September Ends");
			...
			{
				// now playing
				startActivity(new Intent(Wakemeup.this, Nowplaying.class));
	            return true;
			}
			if(item.getItemId()==R.id.action_label)
			{
				//Info
				AlertDialog builder = new AlertDialog.Builder(Wakemeup.this)
