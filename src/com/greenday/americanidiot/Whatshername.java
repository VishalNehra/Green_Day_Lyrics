...
public class Whatshername extends Activity implements OnRefreshListener{
						...
						new CountDownTimer(254000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Whatshername.this, "Finished", Style.CONFIRM).show();
