...
public class Jesusofsuburb extends Activity implements OnRefreshListener{
						...
						new CountDownTimer(548000, 250) {          
							final ScrollView sv = (ScrollView) findViewById(R.id.sv);
							 ...
							 public void onFinish() {  
								 Crouton.makeText(Jesusofsuburb.this, "Finished", Style.CONFIRM).show();
