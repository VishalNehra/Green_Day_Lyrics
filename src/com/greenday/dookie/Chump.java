...
public class Chump extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dookie_chump);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Chump.class);
				    log.info("Dookie/Chump");
				...
				{
					// now playing
					startActivity(new Intent(Chump.this, Nowplaying.class));
		            return true;
				}
				if(item.getItemId()==R.id.action_label)
				{
					//Info
					AlertDialog builder = new AlertDialog.Builder(Chump.this)
