...
public class Pullingteeth extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dookie_pullingteeth);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Pullingteeth.class);
				    log.info("Dookie/Pulling Teeth");
				...
				{
					// now playing
					startActivity(new Intent(Pullingteeth.this, Nowplaying.class));
		            return true;
				}
