...
public class Paperlanterns extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tns_paperlanterns);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Paperlanterns.class);
				    log.info("39-Smooth/Paper Lanterns");
				...
				{
					//Info
					AlertDialog builder = new AlertDialog.Builder(Paperlanterns.this)
