...
public class Tightwad extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.insomniac_tightwad);
	...
	//Action bar code below
			...
			public boolean onOptionsItemSelected(MenuItem item) {
				...
				{
					//Log report
				    Logger log = LoggerFactory.getLogger(Tightwad.class);
				    log.info("Insomniac/Tight Wad Hill");
				...
				{
					//Info
					AlertDialog builder = new AlertDialog.Builder(Tightwad.this)
