...
public class Foughtlaw extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.unreleased_foughtlaw);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			if(item.getItemId()==R.id.reportsong)
			{
				...
				{
			    Logger log = LoggerFactory.getLogger(Foughtlaw.class);
			    log.info("Unreleased/I Fought The Law");
			    Report.report1(this);
				}
				else
				{
