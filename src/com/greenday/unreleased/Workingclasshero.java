...
public class Workingclasshero extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.unreleased_workingclasshero);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Workingclasshero.class);
			    log.info("Unreleased/Working Class Hero");
