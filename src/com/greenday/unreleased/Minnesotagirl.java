...
public class Minnesotagirl extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.unreleased_minnesotagirl);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			if(item.getItemId()==R.id.reportsong)
			{
				...
				{
			    Logger log = LoggerFactory.getLogger(Minnesotagirl.class);
			    log.info("Unreleased/Minnesota Girl");
			    Report.report1(this);
				}
				else
				{
