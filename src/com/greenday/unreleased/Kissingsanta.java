...
public class Kissingsanta extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.unreleased_kissingsanta);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Kissingsanta.class);
			    log.info("Unreleased/I Saw My Parents Kissing Santa Claws");
