...
public class Deadbeat extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.warning_deadbeat);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
			//Log report
		    Logger log = LoggerFactory.getLogger(Deadbeat.class);
		    log.info("Warning/Deadbeat Holiday");
		...
		{
			//Info
			AlertDialog builder = new AlertDialog.Builder(Deadbeat.this)
