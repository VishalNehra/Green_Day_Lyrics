...
public class Dramaqueen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tre_dramaqueen);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Dramaqueen.class);
			    log.info("TRE/Drama Queen");
			...
			{
				//Info
				AlertDialog builder = new AlertDialog.Builder(Dramaqueen.this)
