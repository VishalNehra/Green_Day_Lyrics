...
public class Littleboytrain extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tre_littleboytrain);
	...
	//Action bar code below
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			{
				//Log report
			    Logger log = LoggerFactory.getLogger(Littleboytrain.class);
			    log.info("TRE/Little Boy Named Train");
			    Report.report1(this);
			}
